...
import com.codeontime.konik.Adapter.ContestAdapter;
...
import com.codeontime.konik.ViewModel.ContestsVM;
...
public class Contests extends AppCompatActivity  implements RecylerviewClickInterface {
    ...
    private void getIntentMethod() {
        ...
        {
            dsBookUID = intent.getExtras().getString("dsBookUID");
            dsBookName = intent.getExtras().getString("dsBookName");
