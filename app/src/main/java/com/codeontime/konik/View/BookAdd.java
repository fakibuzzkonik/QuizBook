...
public class BookAdd extends AppCompatActivity {
    private EditText mBookNameEdit, mBookBioEdit, mBookPriority, mBookTotalLevelEdit;
    ...
    //variablles
    private String dsBookName = "NO", dsBookBio = "NO",  dsBookPriority= "NO", dsBookTotalLeve = "NO";
    private int diBookPriority = 0 , diBookTotalLevel = 0;
    @Override
    ...
    private void CheckData() {
        ...
        }else if(dsBookName.equals("NO") || dsBookBio.equals("NO") || dsBookPriority.equals("NO") ||  dsBookTotalLeve.equals("NO")  ){
            Toast.makeText(getApplicationContext(),"Please fillup all ", Toast.LENGTH_SHORT).show();;
        }else if(dsBookName.equals("") || dsBookBio.equals("") || dsBookPriority.equals("") || dsBookTotalLeve.equals("")  ){
            Toast.makeText(getApplicationContext(),"Please fillup all ", Toast.LENGTH_SHORT).show();;
        }else{
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    note.put("BookPassword", "NO");
                                    note.put("BookiPriority", diBookPriority);
                                    note.put("BookiViewCount", 0);
